...
void scene_structure::display_frame()
{
	...
	if(gui.previous_shape != gui.shape_choosen){
		visual.clear();
		gui.previous_shape = gui.shape_choosen;
		const int N = 15;
		if(gui.shape_choosen == 0) shape = mesh_primitive_grid({ -1,-1,0 }, { 1,-1,0 }, { 1,1,0 }, { -1,1,0 }, N, N);
		else{
...
void scene_structure::display_gui()
{
	...
	ImGui::RadioButton("Plane",&gui.shape_choosen, 0); ImGui::SameLine();
	ImGui::RadioButton("Bunny",&gui.shape_choosen, 1);
